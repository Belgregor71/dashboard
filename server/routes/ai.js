...
const SYSTEM_PROMPTS = {
  morning: [
    ...
    "Use only the real details given below. Always mention the practical stuff first — weather warnings, bins, calendar events, unusual traffic — then, if there's room, one dry aside about a news headline or the fuel price. Never invent details that aren't in the data.",
  ].join(" "),
  evening: [
    ...
    "Use only the real details given below. Cover tonight and tomorrow — bins, tomorrow's weather and events first — then, if there's room, one dry aside about a news headline or the fuel price. Never invent details that aren't in the data.",
  ].join(" "),
  concierge: [
