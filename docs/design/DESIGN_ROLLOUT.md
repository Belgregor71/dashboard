...
*(Those 0% figures are pre-`560a32d` `gpucpu.sh` artefacts meaning “below ~25% of a core”, not zero —
see `docs/vision/phase-7-dissolve.md`. The direction was real; the magnitudes are not citable.)*
